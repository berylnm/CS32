...
template <typename KeyType, typename ValueType>
bool combine(const Map<KeyType, ValueType>& m1, const Ma<KeyType, ValueType>p& m2, Map<KeyType, ValueType>& result)
{
...
template <typename KeyType, typename ValueType>
void subtract(const Map<KeyType, ValueType>& m1, const Ma<KeyType, ValueType>p& m2, Map<KeyType, ValueType>& result)
{
      // Guard against the case that result is an alias for m1 or m2
      // (i.e., that result is a reference to the same map that m1 or m2
      // refers to) by building the answer in a local variable res.  When
